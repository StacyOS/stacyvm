...
<div className="stacy-proof-grid">
  <div className="stacy-proof">
    ...
    <span>Your runtime, network, logs, credentials, and certification boundary stay with you.</span>
  </div>
  <div className="stacy-proof">
    <strong>Speed</strong>
    <span>Agents get a simple API for shell, files, streaming output, and previews.</span>
  </div>
  <div className="stacy-proof">
    <strong>Trust</strong>
    <span>TTL cleanup, quotas, audit logs, typed errors, and conformance gates are built in.</span>
  </div>
</div>
