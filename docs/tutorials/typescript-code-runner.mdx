...
The source lives in [`examples/code-runner-typescript`](https://github.com/StacyOS/stacyvm/tree/phase-14-worker-identity-hardening/examples/code-runner-typescript).
